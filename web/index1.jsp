...
<html lang="en">
	...
	<section class="slide1">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1 item1-slick1" style="background-image: url(images/master-slide-02.png);">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
						<span class="caption1-slide1 m-text1 t-center animated visible-false m-b-15" data-appear="fadeInDown">
							Indian Product Collection 2018
						</span>
				...
				<div class="item-slick1 item2-slick1" style="background-image: url(images/master-slide-03.png);">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
				...
				<div class="item-slick1 item3-slick1" style="background-image: url(images/master-slide-04.png);">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
			...
			<div class="row">
				<div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
					...
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						...
						<div class="block1-wrapbtn w-size2">
							<!-- Button -->
							<a href="handicraft.jsp" class="flex-c-m size2 m-text2 bg3 hov1 trans-0-4">
							        HandiCrafts
							</a>
						</div>
					</div>
					...
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						...
						<div class="block1-wrapbtn w-size2">
							<!-- Button -->
							<a href="handmade.jsp" class="flex-c-m size2 m-text2 bg3 hov1 trans-0-4">
								Handmade
							</a>
						</div>
					</div>
				...
				<div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
					...
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						...
						<div class="block1-wrapbtn w-size2">
							<!-- Button -->
							<a href="bedsheet.jsp" class="flex-c-m size2 m-text2 bg3 hov1 trans-0-4">
								BedSheets
							</a>
						</div>
					</div>
					...
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						...
						<div class="block1-wrapbtn w-size2">
							<!-- Button -->
							<a href="footware.jsp" class="flex-c-m size2 m-text2 bg3 hov1 trans-0-4">
								Footerwear
							</a>
						</div>
					</div>
				...
				<div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
					...
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						...
						<div class="block1-wrapbtn w-size2">
							<!-- Button -->
							<a href="bags.jsp" class="flex-c-m size2 m-text2 bg3 hov1 trans-0-4">
								Bags
							</a>
						</div>
					</div>
					...
					<div class="block2 wrap-pic-w pos-relative m-b-30">
						...
						<div class="block2-content sizefull ab-t-l flex-col-c-m">
							<p class="t-center w-size4">
                                                            Welcome <%=ud.get("name")%> Be the first to know about the latest fashion news and get exclu-sive offers
							</p>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-sm-10 col-md-8 col-lg-6 m-l-r-auto p-t-15 p-b-15">
					<div class="hov-img-zoom pos-relative">
						<img src="images/banner-08.png" alt="IMG-BANNER">
	...
	<section class="instagram p-t-20">
		<div class="flex-w">
			...
			<div class="block4 wrap-pic-w">
				<img src="images/gallery-03.png" alt="IMG-INSTAGRAM">
			...
			<!-- Block4 -->
			<div class="block4 wrap-pic-w">
				<img src="images/gallery-07.png" alt="IMG-INSTAGRAM">
			...
			<!-- Block4 -->
			<div class="block4 wrap-pic-w">
				<img src="images/gallery-09.png" alt="IMG-INSTAGRAM">
			...
			<!-- Block4 -->
			<div class="block4 wrap-pic-w">
				<img src="images/gallery-13.png" alt="IMG-INSTAGRAM">
			...
			<!-- Block4 -->
			<div class="block4 wrap-pic-w">
				<img src="images/gallery-15.png" alt="IMG-INSTAGRAM">
