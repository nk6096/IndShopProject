...
<html lang="en">
	...
	<header class="header1">
        ...
        <div class="container-fluid" style="background-color: #99ccff;">
            ...
            <div class="col-sm-4">
                <h2 id="logcol">New User register!!</h2>
                <form action="Register" method="post">
                <input type="text" class="form-control" placeholder="Enter Your Name" name="name" id="name" required><br>
                <input type="text" class="form-control" placeholder="Enter Your Number" name="number" id="number" required><br>
                <input type="text" class="form-control" placeholder="Email Address" name="email" id="email" required><br>
                <label>Gender : </label>
                <div class="form-check form-check-inline">
                <input style="margin-left: 5px;" class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="male" id="male">
                <label class="form-check-label" for="inlineRadio1">Male</label>
                </div>
                <div class="form-check form-check-inline">
                <input style="margin-left: 5px;" class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="female" id="female">
                <label class="form-check-label" for="inlineRadio2">Female</label>
                </div>
                <div class="form-check form-check-inline">
                <input style="margin-left: 5px;" class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="others" id="others">
               ...
               <input style="margin: 20px;" type="submit" class="btn btn-secondary" value="Signup">
                </form>
            </div>
            </div>
        </div>
...
session.setAttribute("msg", "You already logged in");
