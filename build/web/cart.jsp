...
<html lang="en">
    <head>
        ...
        <title>Cart | IndShop provides, Best Indian Product</title>
							...
							<td class="column-1">
								<div class="b-rad-4 o-f-hidden ">
                                             <form action="removecart.jsp" method="Post">
                                                 <input type="hidden" value="<%=rs.getInt(1)%>"  name="cartid"/>
   ...
   <%
    ...
    <center><h5 style="padding-top: 100px;"><b style="color: red;">Your Cart is Empty</b></h5></center><br/>
    <form action="product.jsp">
    <center><input type="submit" style="margin-bottom: 50px;" class="btn btn-primary" value="Shop Now"></button></center>
    </form>
     <%
     }
     %>
